...
class InbiActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when(v.id){
            R.id.icMat ->{
                val intent = Intent(this@InbiActivity, MatbiActivity::class.java)
                startActivity(intent)
            }
            R.id.bckIcon ->{
                val intent = Intent(this@InbiActivity, MainclassActivity::class.java)
                startActivity(intent)
